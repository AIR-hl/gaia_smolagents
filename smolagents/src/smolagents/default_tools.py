    ...
    def __init__(self, *args, authorized_imports=None, **kwargs):
        ...
        self.inputs = {
            "code": {
                "type": "string",
                "description": (
                    "The code snippet to evaluate. All variables used in this snippet must be defined in this same snippet, else you will get an error. "
                    f"This code can only import the all common python librarie, such as requests, pandas, numpy, openpyxl, pymupdf, bf4, etc."
                ),
            }
        }
...
class FinalAnswerTool(Tool):
    name = "final_answer"
    description = "Provides a final answer, and ends the task."
