...
class ChatMessage:
    ...
    @classmethod
    def from_dict(cls, data: dict, raw: Any | None = None, token_usage: TokenUsage | None = None, request_id: str | None = None) -> "ChatMessage":
...
class OpenAIServerModel(ApiModel):
    ...
    def generate_stream(
        ...
        **kwargs,
        ...
        self._apply_rate_limit()
        request_id = "smolagent-"+str(uuid.uuid4())  # Generate a UUID if no request_id is provided
        # Add the request_id to headers
