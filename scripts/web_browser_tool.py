            ...
            if url.startswith("file://"):
                ...
                if "text/" in content_type.lower():
                    ...
                    if res is not None:
                        ...
                        self.page_title = "Conversion Error"
                        self._set_page_content("Failed to convert response content.")
                # A download
                else:
...
class VisitPageTextTool(Tool):
    name = "visit_page_text"
    description = "Visit the webpage at the given URL and return its text content."
...
class DownloadTool(Tool):
    name = "download_file"
    description = """Download a file at a given URL. The file should be of this format: [".xlsx", ".pptx", ".wav", ".mp3", ".m4a", ".png", ".docx"]
...
class FinderTool(Tool):
    ...
    description = 'Scroll the viewport to the first occurrence of the search string. This tool is equivalent to "Ctrl+F" operation.'
    inputs = {
        "search_string": {
            "type": "string",
            "description": "The keyword to search for on the page. This search content supports wildcards like '*'",
        }
    }
    output_type = "string"
